...
*Descriptive Statistics for the Lexicon-1162 Phonological Lexicon Phonological DAS Network and Its Giant Component*

| Statistic | Full network | Giant component |
|:---|---:|---:|
| *Basic* | | |
| Number of nodes | 1,161 | 1,058 |
| Number of edges | 3,227 | 3,206 |
| Density (2*m*/[*n*(*n*−1)]) | 0.00479 | 0.00573 |
| *Degree distribution* | | |
| Mean degree ⟨*k*⟩ | 5.56 | 6.06 |
| Median degree | 5.00 | 5.00 |
| Maximum degree | 18 | 18 |
| Degree assortativity (*r*) | 0.51 | 0.49 |
| 75th percentile degree | 8.00 | 8.00 |
| 90th percentile degree | 12.00 | 12.00 |
| 99th percentile degree | 16.00 | 16.00 |
| *Heavy-tail / power-law fit (Clauset MLE)* | | |
| Power-law exponent (*α*) | 2.69 | 2.69 |
| Power-law *x*ₘᵢₙ | 5 | 5 |
| Tail size (*n* with degree ≥ *x*ₘᵢₙ) | 595 | 595 |
| KS distance (*D*) | 0.1380 | 0.1380 |
| vs. lognormal: *R* (*p*) | -9.11 (< .001) | -9.11 (< .001) |
| vs. exponential: *R* (*p*) | -14.43 (< .001) | -14.43 (< .001) |
| vs. truncated power law: *R* (*p*) | -14.43 (< .001) | -14.43 (< .001) |
| *Local structure & community* | | |
| Average local clustering ⟨*C*⟩ | 0.29 | 0.31 |
| Transitivity (global clustering) | 0.33 | 0.33 |
| Number of triangles | 2,703 | 2,702 |
| Modularity (greedy, *Q*) | 0.67 | 0.67 |
| *k*-core depth | 8 | 8 |
| *Connectivity & fragmentation* | | |
| Number of components | 84 | 1 (by definition) |
| Hermits (degree 0) | 66 | 0 (by definition) |
| Hermit fraction (of lexicon) | 0.06 | — |
| Giant component (GC) size | 1,058 | 1,058 |
| GC fraction (of lexicon) | 0.91 | 1.00 |
| Non-GC subgraph count (size ≥ 2) | 17 | — |
| Non-GC subgraph mean size | 2.18 | — |
